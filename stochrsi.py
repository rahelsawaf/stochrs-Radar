...
symbols1 = ["1INCH", "AI16Z", "AAVE", "ACA", "ACE", "ACH", "ACT", "ADA", "ADX", "AERGO", "AGI", "AGIX", "AGLD", "AIOZ", "AITECH", "AIXBT", "AKT", "ALEPH", "ALGO", "ALICE", "ALPINE", "ALT", "AMP", "ANKR", "ANT", "ANYONE", "AOA", "APE", "API3", "APT", "AR", "ARB", "ARC", "ARKM", "ARPA", "ARRR", "ARX", "ASTR", "ATA", "ATH", "ATOM", "AURORA", "AVA", "AVAIL", "AVAX", "AZERO", "BAND", "BAT", "BANANA", "BCUT", "BDX", "BEPRO", "BICO", "BIO", "BIDP", "BLOK", "BLUR", "BLZ", "BOBA", "BOND", "BRG", "BRISE", "BTG", "BTT", "CARV", "CCD", "CELO", "CELR", "CERE", "CFX", "CHEQ", "CHR", "CHZ", "CIRUS", "CKB", "CLV", "COMBO", "COOKIE", "CQT", "CRPT", "CSPR", "CTI", "CTRL", "CTSI", "CUDOS", "CVC", "CWEB", "CXT", "CYBER", "DAG", "DATA", "DBC", "DCK", "DCR", "DEGEN", "DENT", "DERO", "DEXE", "DGB", "DIA", "DMAIL", "DMTR", "DOAI", "DOCK", "DORA", "DOT", "DPR", "DUSK", "DVPN", "DRGN", "EDU", "EFX", "EGLD", "EGO", "ELA", "ELF", "ENJ", "ENS", "EOS", "EPIK", "ETC", "ETHW", "EWT", "FET", "FIDA", "FIL", "FLOW", "FLR", "FLUX", "FORT", "FRA", "FTON", "FUEL", "FX", "GAL", "GAS", "GFT", "GHX", "GLM", "GLMR", "GLQ", "GMM", "GMRX", "GMT", "GO", "GRASS", "GRT", "GTAI", "GTC", "HAI", "HBAR", "HEART", "HERO", "HIGH", "HMND", "HNT", "HTR", "HYVE"]

symbols2 = ["ICE", "ICP", "ICX", "ID", "INSP", "IO", "IOST", "IOTX", "IRON", "ISME", "ISP", "ISSP", "JASMY", "KAI", "KAIA", "KARRAT", "KAS", "KAT", "KDA", "KEY", "KMA", "KMD", "KSM", "L3", "LAI", "LINK", "LIT", "LITH", "LKI", "LL", "LMR", "LOOKS", "LOOM", "LPT", "LRC", "LSK", "LSS", "LTO", "LUNA", "LYX", "MAN", "MANA", "MANTA", "MARSH", "MASA", "MASK", "ME", "MERL", "METIS", "MINA", "MIND", "MOBILE", "MOCA", "MOVE", "MOVR", "MPLX", "MTL", "MTS", "MTV", "MYRIA", "NATIX", "NAVI", "NEAR", "NETVR", "NFP", "NFT", "NIBI", "NKN", "NLK", "NS", "NUM", "NXRA", "NYM", "OAS", "OCEAN", "OCN", "OFN", "OGN", "OM", "OMG", "OMN", "OMNI", "ONE", "OORT", "OP", "ORAI", "ORBS", "ORDI", "OVR", "OXT", "PAXG", "PEAQ", "PHA", "POKT", "POLYX", "POND", "PORT3", "PORTAL", "POWR", "PRE", "PROM", "PRQ", "PUMLX", "PYTH", "PLUME", "PYUSD", "QKC", "QNT", "QTUM", "RDNT", "REQ", "REV", "RLC", "RNDR", "ROOT", "ROSE", "ROUP", "RSR", "RVN", "SAFE", "SAND", "SAVM", "SCRT", "SDM", "SDN", "SEI", "SERO", "SFP", "SKL", "SLF", "SLN", "SMH", "SOUL", "STMX", "STORE", "STORJ", "STRAX", "STX", "SUI", "SWASH", "SWEAT", "SWFTC", "SXP", "SYS", "TADA", "TAIKO", "TAO", "TARA", "TEL", "TFUEL", "THETA", "TIA", "TLOS", "TNSR", "TON", "TRAC", "TRB", "TRIAS", "TRUF", "TRVL", "TWT", "TXA", "UBX", "UMA", "USDP", "UTK", "UXLINK", "VANA", "VANRY", "VEMP", "VET", "VIDT", "VIRTUAL", "VR", "VRA", "VSYS", "VXV", "W", "WAVES", "WELL", "WEST", "WILD", "WIN", "WLD", "WMT", "WOOP", "WORK", "WRX", "WSDM", "WXT", "XAI", "XCH", "XDB", "XDC", "XEC", "XEM", "XION", "XLM", "XMR", "XPR", "XRD", "XRP", "XTAG", "XTZ", "XYO", "ZBCN", "ZELIX", "ZEN", "ZETA", "ZIL", "ZK", "ZKJ", "ZRO"]
